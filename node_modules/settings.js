...
function Settings(){
    ...
    for(var i = 0; i < settingsContent.length; i++){
      ...
      if(lineParts[0] === 'dimension'){
        ...
        if(lineParts[0] === 'subredditlist'){
          ...
          console.log('Loaded subredditslist as ' + lineParts[1].split(','));
        }else{
  ...
  this.getLocalImages = getLocalImages;
  ...
  this.sizeOfWallpaper = sizeOfWallpaper;
  this.createDimensionString = createDimensionString;
  this.loadLocalImages = loadLocalImages;
}
