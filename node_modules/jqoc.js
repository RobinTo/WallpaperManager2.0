...
function JQOC($){
  ...
  function createWallpaperInfo(title, info){
    var newInfo = $('<div class="fullWallpaperInfo popup"><span class="title">' + title + ' </span> ' + info +' <div class="rightAlign"><button class="setWallpaperButton">Set Wallpaper</button></div></div>');
    return newInfo;
  }
  ...
  this.createWallpaperInfo = createWallpaperInfo;
}
